...
ipv6_header_analyze(const u_char *packet)
{
	...
	printf("Next header: (%i) ", ipv6_header->ip6_nxt);
	switch (ipv6_header->ip6_nxt)
	{
		case 0:
			puts("Hop-by-hop Options Header");
			break;
		case 6:
			puts("TCP");
			break;
		case 17:
			...
			break;
		case 41:
			puts("Encapsulated IPv6 Header");
			break;
		case 43:
			puts("Routing Header");
			break;
		case 44:
			puts("Fragment Header");
			break;
		case 46:
			puts("Resource ReSerVation Protocol");
			break;
		case 50:
			puts("Encapsulating Security Payload");
			break;
		case 51:
			puts("Authentication Header");
			break;
		case 58:
			puts("ICMPv6");
			break;
		case 59:
			...
			break;
		case 60:
			puts("Destination Options Header");
			break;
		default:
